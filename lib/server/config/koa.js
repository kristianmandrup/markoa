...
module.exports = function(app, options) {
  return {
    ...
    start: function(appContainer) {
      ...
      let refresh = false; // options.refresh || this.default.refresh;
      let reload = false; // appContainer.reload || options.reload || this.default.reload;
      ...
      if (reload) {
        ...
        markoConfig({views: appContainer.views, apps: appContainer.apps});
      }
